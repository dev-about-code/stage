...
public final class SubscriptionManager<HandleT, ListenerT, HandbackT> {
     ...
     *
     * @return An implementation of {@link HandleFactory} that generates incrementing long values
     */
     ...
     *                    events.
     * @param <HandbackT> The type of handback that should be passed to a task execution
     *
     * @return A subscription manager that executes tasks synchronously, using the default long
     * handle factory.
     */
     ...
     * having to wait for execution), using the default long handle factory.
     *
     * @param <ListenerT> The listener type this subscription manager uses to consume published
     *                    events.
     * @param <HandbackT> The type of handback that should be passed to a task execution
     *
     * @return A subscription manager that executes tasks asynchronously (without the publisher
     * having to wait for execution), using the default long handle factory.
     */
     ...
     * factory.
     *
     * @param handleFactory The factory to create handles for subscriptions
     * @param <HandleT>     The type of handle this subscription manager uses for identification of
     *                      subscribers
     * @param <ListenerT>   The listener type this subscription manager uses to consume published
     *                      events.
     * @param <HandbackT>   The type of handback that should be passed to a task execution
     *
     * @return A subscription manager that executes tasks synchronously, using the specified handle
     * factory.
     */
    ...
    /**
     * Creates a subscription manager that executes tasks asynchronously (without the publisher
     * having to wait for execution), using the specified handle factory.
     *
     * @param handleFactory The factory to create handles for subscriptions
     * @param <HandleT>     The type of handle this subscription manager uses for identification of
     *                      subscribers

         ...
         public void apply(boolean isParameterPresent, String stringValue)
            ...
            if (stringValue == null) {
               ...
               if (mustExist) {
                  if (!file.exists()) {
                     throw new IllegalArgumentException(
                         String.format("File '%s' should exists, but does not", stringValue));
                  }
               }
            ...
            if (stringValue != null) {
               try {
                  ...
                  throw new IllegalArgumentException(String.format(
                      "Error parsing float parameter '%s': %s", stringValue, e.getMessage()));
               }
            }
         ...
         public void apply(boolean isParameterPresent, String stringValue) {
            ...
            if (stringValue != null) {
               try {
                  ...
                  throw new IllegalArgumentException(String.format(
                      "Error parsing double parameter '%s': %s", stringValue, e.getMessage()));
               }
            }
            consumer.accept(value);
         }
         ...
         public void apply(boolean isParameterPresent, String stringValue) {
            ...
            if (stringValue != null) {
               try {
                  ...
                  throw new IllegalArgumentException(String.format(
                      "Error parsing long parameter '%s': %s", stringValue, e.getMessage()));
               }
            }
            consumer.accept(value);
         }
         ...
         public void apply(boolean isParameterPresent, String stringValue) {
            ...
            if (stringValue != null) {
               try {
                  ...
                  throw new IllegalArgumentException(String.format(
                      "Error parsing integer parameter '%s': %s", stringValue, e.getMessage()));
               }
            }
            consumer.accept(value);
         }
         ...
         public void apply(boolean isParameterPresent, String stringValue) {
            ...
            if (stringValue != null) {
               try {
                  ...
                  throw new IllegalArgumentException(String.format(
                      "Error parsing boolean parameter '%s': %s", stringValue, e.getMessage()));
               }
            }
            consumer.accept(value);
         }
